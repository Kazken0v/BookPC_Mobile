    ...
    <GlowCard glow="cyan" padding="p-4">
      <View style={{ flexDirection: "row", alignItems: "center", gap: 12, marginBottom: 12 }}>
        ...
        <View style={{ flex: 1 }}>
          ...
          <Text style={{ fontSize: 12, color: colors.textMuted }}>Cofou Loyalty Points</Text>
        </View>
  ...
  return (
    <ScrollView style={{ flex: 1, backgroundColor: colors.bg }} showsVerticalScrollIndicator={false}>
      <View style={{ gap: 20, paddingHorizontal: 16, paddingTop: 16, paddingBottom: 16 }}>
        ...
        <Text style={{ textAlign: "center", fontSize: 12, color: "#555570" }}>Cofou v1.0.0 · Made for gamers</Text>
      </View>
    </ScrollView>
  );
}
