...
import { Search, MapPin, Star, Clock, Zap, ChevronRight, Wifi, Trophy, ChevronDown } from "lucide-react-native";
import { Club, Zone } from "../data/mockClubs";
        ...
        <View style={{ gap: 12 }}>
          {loading ? (
            <View style={{ alignItems: "center", paddingVertical: 24 }}>
              <Text style={{ color: colors.textMuted, fontSize: 14 }}>Loading clubs...</Text>
            </View>
          ) : filtered.length === 0 ? (
